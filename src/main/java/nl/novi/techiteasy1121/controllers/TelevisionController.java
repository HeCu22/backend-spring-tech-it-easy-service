...
public class TelevisionController {
    ...
    public ResponseEntity<List<SalesDto>> getAllTelevisionsSales() {

        List<SalesDto> dtoSales;

        dtoSales = televisionService.getAllTelevisionsSales();

        return ResponseEntity.ok().body(dtoSales);
    }
